...
public class xxe {
	...
	public void leerArchivos(){
		...
		for(String linea : lineas) {
			...
			int[] ingredientes = new int[] {Integer.parseInt(datos1[3]), Integer.parseInt(datos1[4]), Integer.parseInt(datos1[5]), Integer.parseInt(datos1[6]), Integer.parseInt(datos1[7]), Integer.parseInt(datos1[8])};
			this.ingresarProductocomp(Integer.parseInt(datos1[1]), ingredientes, Integer.parseInt(datos1[10]), datos1[11], Integer.parseInt(datos1[12]));
		}
		}
